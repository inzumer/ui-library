...
export default defineConfig({
  entry: {
    ...
    'components/atoms/Textarea/index': 'src/components/atoms/Textarea/index.ts',
    'components/molecules/Accordion/index': 'src/components/molecules/Accordion/index.ts',
    ...
    'components/molecules/Table/index': 'src/components/molecules/Table/index.ts',
